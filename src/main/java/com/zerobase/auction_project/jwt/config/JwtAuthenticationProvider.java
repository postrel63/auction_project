...
//    private final String secretKey = System.getenv("SECRET_KEY");
    ...
    public boolean validateToken(String jwtToken) {
        try {
            ...
            e.printStackTrace();
            System.out.println("validate Token err:" + e.getMessage());
            return false;
        }
    }
